...
namespace JKWatcher.RandomHelpers
{
    ...
    static class BSPToMiniMap
    {
        ...
        public static unsafe void MakeMiniMap(string mapNameClean,byte[] bspData, float pixelsPerUnit = 0.1f, int maxWidth = 4000, int maxHeight = 4000, int extraBorderUnits = 100)
        {
            bool isQ3 = false;

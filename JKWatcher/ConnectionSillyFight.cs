...
namespace JKWatcher
{
	...
	public partial class Connection
	{
		...
		static readonly PlayerInfo dummyPlayerInfo = new PlayerInfo(new Glicko2.RatingCalculator(), new Glicko2.RatingCalculator(), 0,null) {  position = new Vector3() { X= float.PositiveInfinity ,Y= float.PositiveInfinity ,Z= float.PositiveInfinity } };
